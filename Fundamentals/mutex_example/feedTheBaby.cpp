  ...
  //  YOUR CODE HERE
	...
	pthread_attr_setdetachstate(&tAttr,PTHREAD_CREATE_DETACHED);
        	...
        	if(input == 0)
		{
                	...
                	pthread_t tId;
			mealArray[mealCount] = tId;
			mealCount++;
			char *food = (char*) selectFood();
			pthread_create(&tId,&tAttr,processMeal, food);
...
// Q: What happens when you feed your baby too rapidly? 
//
// A:	Since the large intestine can only take one meal,
//	eventually two threads will try to access it and give it more than one meal,
//	which will cause it to return EXIT_FAILURE and crash the program.
//
